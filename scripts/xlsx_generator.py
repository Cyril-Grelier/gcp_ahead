...
def main():
    ...
    methods: list[tuple(str, str)] = [
        # LS
        # ("PartialCol", "outputs/gcp_hard_ls_2h/partial_col"),
        # ("TabuCol", "outputs/gcp_hard_ls_2h/tabu_col"),
        # # HEAD
        # ("HEAD+PartialCol", "outputs/gcp_hard_head_1h/partialcol"),
        # ("HEAD+TabuCol", "outputs/gcp_hard_head_1h/tabucol"),
        # # AHEAD
        # # ("AHEAD+Random", "outputs/gcp_hard_ahead_1h/random"),
        # # ("AHEAD+Roulette", "outputs/gcp_hard_ahead_1h/roulette"),
        # # ("AHEAD+Deleter", "outputs/gcp_hard_ahead_1h/deleter"),
        # # ("AHEAD+UCB", "outputs/gcp_hard_ahead_1h/ucb"),
        # # ("AHEAD+Pursuit", "outputs/gcp_hard_ahead_1h/pursuit"),
        # # ("AHEAD+NN", "outputs/gcp_hard_ahead_1h/nn"),
        #
        # article
        ("PartialCol", "outputs/gcp_hard_ls_2h/partial_col"),
        ("HEAD+PartialCol", "outputs/gcp_hard_head_1h/partialcol"),
        ("TabuCol", "outputs/gcp_hard_ls_2h/tabu_col"),
        ("HEAD+TabuCol", "outputs/gcp_hard_head_1h/tabucol"),
        ("AHEAD+Random", "outputs/gcp_hard_ahead/random"),
        ("AHEAD+Roulette", "outputs/gcp_hard_ahead/roulette"),
        ("AHEAD+Deleter", "outputs/gcp_hard_ahead/deleter"),
        ("AHEAD+UCB", "outputs/gcp_hard_ahead/ucb"),
        ("AHEAD+Pursuit", "outputs/gcp_hard_ahead/pursuit"),
        ("AHEAD+NN", "outputs/gcp_hard_ahead/nn"),
    ]

    problem = "gcp"

    output_file = "xlsx_files/gcp_hard_ahead_with_te.xlsx"
...
class Method:
    def __init__(self, name: str, repertory: str, instance_name) -> None:
        self.name: str = name
