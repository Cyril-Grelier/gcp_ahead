...
class AdaptiveHelper {
  ...
  public:
    AdaptiveHelper(const ParamAdapt &param_);
     ...
     *
     * @param index_solution  the index of the solution i-1/nb_selected
     * @param operator_number operator selected
     * @param solution solution reached
     */
    virtual void update_obtained_solution(const int index_solution,
...
class AdaptiveHelper_none : public AdaptiveHelper {
  public:
    AdaptiveHelper_none(const ParamAdapt &param_);
...
class AdaptiveHelper_iterated : public AdaptiveHelper {
  public:
    AdaptiveHelper_iterated(const ParamAdapt &param_);
...
class AdaptiveHelper_random : public AdaptiveHelper {
  public:
    AdaptiveHelper_random(const ParamAdapt &param_);
...
class AdaptiveHelper_deleter : public AdaptiveHelper {
  ...
  public:
    AdaptiveHelper_deleter(const ParamAdapt &param_);
...
class AdaptiveHelper_roulette_wheel : public AdaptiveHelper {
  public:
    AdaptiveHelper_roulette_wheel(const ParamAdapt &param_);
...
class AdaptiveHelper_pursuit : public AdaptiveHelper {
  public:
    AdaptiveHelper_pursuit(const ParamAdapt &param_);
...
class AdaptiveHelper_ucb : public AdaptiveHelper {
  public:
    AdaptiveHelper_ucb(const ParamAdapt &param_);
...
class AdaptiveHelper_neural_net : public AdaptiveHelper {
  ...
  public:
    AdaptiveHelper_neural_net(const ParamAdapt &param_);
     ...
     */
    int get_operator(const int index_solution, const Solution &solution);

    /**
     * @brief Used to update _solutions and _utility_operator tensors
     */
    void update_obtained_solution(const int index_solution,
                                  const int operator_number,
                                  const int score) override;

    void update_helper() override;

    int select_best(const std::vector<Solution> &children);
};
